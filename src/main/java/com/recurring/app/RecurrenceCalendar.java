...
public class RecurrenceCalendar {
     ...
     */
    public static RecurrenceCalendar getInstance(LocalDateTime startLocalDate, String icalString) {
     ...
     * @return an instance of RecurrenceCalendar
     */
    public static RecurrenceCalendar getInstance(LocalDateTime startLocalDate, RecurrenceRule rule) {
        ...
        instance.end = Optional.ofNullable(rule.getUntil())
                .map(until -> until.toInstant().atZone(ZoneId.systemDefault()).toLocalDateTime())
                .orElse(null);
        switch (rule.getFreq()) {
            case DAILY:
            ...
            case WEEKLY:
                ...
                break;
            default:
                MonthlyRecurrenceGenerator monthlyGenerator =
                        new MonthlyRecurrenceGenerator(instance.dateCursor, rule);
    ...
    private boolean isExceededEndDate(LocalDateTime date) {
